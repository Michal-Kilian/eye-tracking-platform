...
class Detector3D:
    ...
    def detect(self, result_2d, frame_gray, display_normal_wcs, display_position_wcs, display_rotation_wcs):
        ...
        plane_intersection = MathHelpers.get_point([eye_position_wcs, gaze_ray_wcs], intersection_time)

        plane_intersection = MathHelpers.transfer_vector(plane_intersection, display_position_wcs, display_rotation_wcs)

        uv_coords = MathHelpers.convert_to_uv(plane_intersection, CONFIG.DISPLAY_WIDTH, CONFIG.DISPLAY_HEIGHT)
